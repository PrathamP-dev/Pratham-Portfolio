...
const CertificationsCarousel = ({ isVisible }: CertificationsCarouselProps) => {
  ...
  const certificationImages = [
    "/lovable-uploads/emotional-intelligence-cert.png", // LinkedIn Learning Emotional Intelligence
    ...
    <div className={`w-full mt-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`}>
      <div className="relative">
        ...
        <button 
          ...
          className="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-white/10 backdrop-blur-sm rounded-full p-2 text-white hover:bg-white/20 transition-all duration-300 -ml-4"
        ...
        <button 
          ...
          className="absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-white/10 backdrop-blur-sm rounded-full p-2 text-white hover:bg-white/20 transition-all duration-300 -mr-4"
